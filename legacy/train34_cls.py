...
def validate(net, data_loader):
    ...
    wandb.log({"val_score_step": sc, "val_dice_step": d0, })
    return sc
...
if __name__ == '__main__':
    ...
    wandb.init(project="xview2_no1_solution", tags=["resnet34", "cls"], notes=f"seed: {seed}",
               dir="/local_storage/users/paulbp/xview2/logs/")
