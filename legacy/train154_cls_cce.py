...
loc_folder = '/local_storage/users/paulbp/xview2/pred_loc_val'
...
def train_epoch(current_epoch, seg_loss, ce_loss, model, optimizer, scheduler, train_data_loader):
    ...
    for i, sample in enumerate(iterator):
        ...
        loss = 0.1 * loss0 + 0.1 * loss1 + 0.6 * \
            loss2 + 0.3 * loss3 + 0.2 * loss4 + loss5 * 8
...
if __name__ == '__main__':
    ...
    scheduler = lr_scheduler.MultiStepLR(optimizer,
                                         milestones=[3, 5, 9, 13, 17, 21, 25, 29, 33, 47, 50, 60, 70, 90, 110, 130, 150,
                                                     170, 180, 190], gamma=0.5)
